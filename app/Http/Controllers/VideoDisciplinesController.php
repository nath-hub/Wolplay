    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $video = DB::transaction(function () use ($validated, $request, $userId) {
            ...
            $video = Video::create([
                ...
                'thumbnailUrl'         => "https://img.youtube.com/vi/{$request->input('youtubeId')}/hqdefault.jpg" ?? $request->input('thumbnailUrl'),
                'title'             => $request->input('title'),
                'description'       => $request->input('description'),
                'thumbnail_url'     => "https://img.youtube.com/vi/{$request->input('youtubeId')}/hqdefault.jpg",
